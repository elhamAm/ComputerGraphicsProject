...
reference = cv2.imread("reference.exr",  cv2.IMREAD_ANYCOLOR | cv2.IMREAD_ANYDEPTH)  
...
img_to_save = GammaCorrection(reference)
SaveImage("reference.jpg", img_to_save)
