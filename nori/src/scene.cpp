...
Scene::Scene(const PropertyList &) {
    std::cout << "scene start" <<endl;
    m_bvh = new BVH();
    std::cout << "scene doone" <<endl;
...
void Scene::addChild(NoriObject *obj) {
    std::cout << "add child called" << endl; 
    switch (obj->getClassType()) {
        ...
        case EEmitter:
            if (static_cast<Emitter*>(obj)->toString() == "environment_map"){
                    m_envEmitter = static_cast<Emitter*>(obj);
        ...
        default:
            throw NoriException("Scene::addChild(<%s>) is not supported blablablabl!",
