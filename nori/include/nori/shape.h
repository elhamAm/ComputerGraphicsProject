...
public:
    ...
    virtual void setHitInformation(uint32_t index, const Ray3f &ray, Intersection & its, Vector3f & tangent) const = 0;

    virtual void applyNormalMap(Intersection & its, Vector3f & tangent) const;
    /**
